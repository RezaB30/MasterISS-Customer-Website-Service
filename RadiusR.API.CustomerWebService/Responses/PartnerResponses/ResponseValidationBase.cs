    ...
    public static class Validator
    {
        public static ValidationElement Required(string value , string paramName)
        {
            if (string.IsNullOrEmpty(value))
            {
                ...
                {
                    Key = "Required",
                    Value = string.Format(Localization.ErrorMessages.Required, paramName)
                };
            }
            return null;
        }
        public static ValidationElement MaxLength(string value, int length , string paramName)
        {
            if (value.Length > length)
            {
                ...
                {
                    Key = "MaxLength",
                    Value = string.Format(Localization.ErrorMessages.MaxLength, paramName, length)
                };
            }
            return null;
        }
        public static ValidationElement ValidateEmail(string value , string paramName)
        {
            ...
            if (!validate.Success)
            {
                ...
                {
                    Key = "InvalidEmail",
                    Value = string.Format(Localization.ErrorMessages.InvalidEmail, paramName)
                };
            }
            return null;
        }
