...
using RadiusR.API.CustomerWebApi.Localization;
    ...
    public static class CommonResponse
    {
        ...
        public static ServiceResponse ClientNotFound(string culture)
        {
            return new ServiceResponse()
            {
                ...
                ErrorMessage = new RezaB.Data.Localization.LocalizedList<ErrorCodes, RadiusR.API.CustomerWebApi.Localization.Common>().GetDisplayText((int)ErrorCodes.ClientNotFound, CreateCulture(culture))
            };
        }
        ...
        public static ServiceResponse HasActiveRequest(string culture)
        {
            return new ServiceResponse()
            {
                ...
                ErrorMessage = new RezaB.Data.Localization.LocalizedList<ErrorCodes, RadiusR.API.CustomerWebApi.Localization.Common>().GetDisplayText((int)ErrorCodes.HasActiveRequest, CreateCulture(culture))
            };
        }
